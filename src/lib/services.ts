...
export const services: Service[] = [
  {
    ...
    metaDescription:
      "Custom cold room installation in Brisbane. QBCC licensed, 5-year warranty, 24/7 service. Fixed-price quote in 24 hours. Call Keith on 0432 115 513.",
    intro:
      "Brisbane's most trusted custom cold room installer. Cherry Refrigeration designs, manufactures and installs commercial cold rooms across Brisbane, the Gold Coast and South East Queensland — with refrigeration and electrical work delivered by one in-house team.",
    bullets: [
      "Custom-built to your exact floor plan",
      "Energy-efficient 100mm/150mm EPS panels",
      "QBCC, ARC and Master Electricians licensed",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Master Electricians member — full insurance",
    ],
    body: [],
    faqs: [],
